...
- Jackie, AI Assistant 👩🏻‍🏫 (`@n8n/n8n-nodes-langchain.agent`)

## All Nodes

| Node Name | Type | Category |
|-----------|------|----------|
| Google Calendar | `n8n-nodes-base.googleCalendarTool` | Other |
| Window Buffer Memory | `@n8n/n8n-nodes-langchain.memoryBufferWindow` | AI |
| Get Email | `n8n-nodes-base.gmailTool` | Output |
| Listen for incoming events | `n8n-nodes-base.telegramTrigger` | Trigger |
| Telegram | `n8n-nodes-base.telegram` | Output |
| If | `n8n-nodes-base.if` | Transform |
| Voice or Text | `n8n-nodes-base.set` | Transform |
| Get Voice File | `n8n-nodes-base.telegram` | Output |
| OpenRouter | `@n8n/n8n-nodes-langchain.lmChatOpenRouter` | AI |
| Create a task in Google Tasks | `n8n-nodes-base.googleTasksTool` | Other |
| Get many tasks in Google Tasks | `n8n-nodes-base.googleTasksTool` | Other |
| Transcribe a recording | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Send Email | `n8n-nodes-base.gmailTool` | Output |
| Jackie, AI Assistant 👩🏻‍🏫 | `@n8n/n8n-nodes-langchain.agent` | AI |

## Connections

```
If --[main]--> Get Voice File
If --[main]--> Jackie, AI Assistant 👩🏻‍🏫
Get Email --[ai_tool]--> Jackie, AI Assistant 👩🏻‍🏫
OpenRouter --[ai_languageModel]--> Jackie, AI Assistant 👩🏻‍🏫
Send Email --[ai_tool]--> Jackie, AI Assistant 👩🏻‍🏫
Voice or Text --[main]--> If
Get Voice File --[main]--> Transcribe a recording
Google Calendar --[ai_tool]--> Jackie, AI Assistant 👩🏻‍🏫
Window Buffer Memory --[ai_memory]--> Jackie, AI Assistant 👩🏻‍🏫
Transcribe a recording --[main]--> Jackie, AI Assistant 👩🏻‍🏫
Listen for incoming events --[main]--> Voice or Text
Create a task in Google Tasks --[ai_tool]--> Jackie, AI Assistant 👩🏻‍🏫
Get many tasks in Google Tasks --[ai_tool]--> Jackie, AI Assistant 👩🏻‍🏫
Jackie, AI Assistant 👩🏻‍🏫 --[main]--> Telegram
```

## Workflow Summary

This workflow is triggered by Listen for incoming events, uses Window Buffer Memory, OpenRouter, Transcribe a recording, Jackie, AI Assistant 👩🏻‍🏫 for AI processing, goes through 2 transformation step(s), finally outputs to Get Email, Telegram, Get Voice File, Send Email.
## Author Information
- **Name**: Derek Cheung
