...
1. ✅ **Read relevant standards documentation** (OPA-enforced)
...
**For n8n workflows:**
- [ ] **MANDATORY: Use all 7 required MCP tools** (OPA-enforced)
...
- [ ] **OPA Policy Check:** Run `bash scripts/enforcement/check-opa-policy.sh n8n-workflow-builder ACT` before completion
